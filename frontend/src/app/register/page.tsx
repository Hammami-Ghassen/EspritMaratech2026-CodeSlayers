...
import { Eye, EyeOff, Mail, Phone, AlertCircle, CheckCircle2, Circle, XCircle, Info } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    ...
    <AuthLayout fullWidth>
      ...
      {/* Form — two-column grid on large screens */}
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="grid grid-cols-1 gap-x-10 gap-y-6 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <div className="pointer-events-none absolute inset-y-0 start-0 flex items-center ps-3">
                <Phone className="h-5 w-5 text-[#92a4c9]" aria-hidden="true" />
              </div>
              <input
                id="phone"
                type="tel"
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Login link */}
          <div className="text-center text-base text-[#92a4c9]">
            {t('hasAccount')}{' '}
            <Link
              href="/login"
